-- Pricely — Supabase schema (Phase 7)
...
-- Watchlist is user-scoped and auth-guarded via RLS.
...
-- Alerts are user-scoped and auth-guarded via RLS.
...
-- Price history (optional persistence).
-- Partitioning is recommended in production but kept simple here for portability.
