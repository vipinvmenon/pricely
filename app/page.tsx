...
const WATCHLIST_PREVIEW = [
  ...
  { name: 'Apple iPad Air 11"', retailer: 'Flipkart', price: 58999, save: 5901 },
  { name: 'Dyson V12 Detect Slim', retailer: 'Amazon', price: 44990, save: 7910 },
  { name: 'Asics Novablast 4', retailer: 'Flipkart', price: 8249, save: 4750 },
]

function TrackIllustration() {
  return (
    <svg viewBox="0 0 160 80" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 80 }}>
      <polyline
  ...
  return (
    <svg viewBox="0 0 160 80" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 80 }}>
      ...
      <polyline
        ...
        opacity="0.5"
      />
      <line x1="110" y1="0" x2="110" y2="80" stroke="rgba(255,255,255,0.12)" strokeWidth="1" strokeDasharray="3 3" />
      <text x="104" y="74" style={{ fontFamily: 'var(--font-mono)', fontSize: 8, fill: 'var(--accent)' }}>NOW</text>
      <text x="144" y="18" style={{ fontFamily: 'var(--font-mono)', fontSize: 8, fill: 'rgba(255,255,255,0.4)' }}>+30d</text>
    </svg>
  )
}
      ...
      >
        <div
          ...
          style={{
            position: 'absolute',
            inset: 0,
            background: 'radial-gradient(ellipse 60% 40% at 20% 50%, rgba(30,215,96,0.07) 0%, transparent 70%)',
            pointerEvents: 'none',
          }}
        />
        ...
        >
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              <Button variant="primary" size="lg">Track a product</Button>
          ...
          <div>
            ...
            >
              Pricely watches prices across Blinkit, Zepto, Amazon, Flipkart, Croma and 7 more — so you
              never have to open 12 tabs again. Set a target, get alerted, save money.
            </p>
            ...
            >
              {[
                ...
                <div key={stat.label}>
                  ...
                  <div style={{ fontSize: '0.8125rem', color: 'var(--text-dim)' }}>{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section style={{ padding: '0 24px 100px', maxWidth: 1200, margin: '0 auto' }}>
        ...
        >
          {HOW_IT_WORKS.map((card) => (
            <Glass key={card.label} variant="plate" style={{ padding: 'var(--sp-8)' }}>
              <div
                style={{
              ...
              <p style={{ fontSize: '0.9rem', color: 'var(--text-dim)', lineHeight: 1.65, margin: 0 }}>
                {card.body}
              </p>
            </Glass>
          ))}
              ...
              {WATCHLIST_PREVIEW.map((item) => (
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: '0.75rem', color: 'var(--text-faint)' }}>{item.retailer}</div>
                  </div>
                  <div style={{ textAlign: 'right', flexShrink: 0 }}>
                    <div className="mono" style={{ fontSize: '0.9375rem', fontWeight: 600, color: 'var(--text)' }}>
